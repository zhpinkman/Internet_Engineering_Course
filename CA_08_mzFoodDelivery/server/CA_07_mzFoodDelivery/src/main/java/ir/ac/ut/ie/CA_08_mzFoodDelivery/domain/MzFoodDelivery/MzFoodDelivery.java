package ir.ac.ut.ie.CA_08_mzFoodDelivery.domain.MzFoodDelivery;
...
import ir.ac.ut.ie.CA_08_mzFoodDelivery.domain.MzFoodDelivery.FoodParty.FoodPartyManager;
import ir.ac.ut.ie.CA_08_mzFoodDelivery.domain.MzFoodDelivery.Restaurant.*;
...
import ir.ac.ut.ie.CA_08_mzFoodDelivery.domain.MzFoodDelivery.User.UserManager;
...
//    }
    ...
    private void removeItemsInCart() throws SQLException {
        for (CartItem cartItem : userManager.getAllCarts()) {
